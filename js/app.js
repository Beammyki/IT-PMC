  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id:'salary', num:'10', title:'ระบบเงินเดือน HR', desc:'ระบบจัดการเงินเดือนพนักงาน',      icon:'card-icon--teal', svg:'M2 4h12v8H2zM5 4V2h6v2M8 7v3M6 9h4',          url:'http://192.168.78.228:8501/' },
      ]
    },
    {
      label: 'Office',
