  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id:'excel', num:'12', title:'Excel Admin PGSN', desc:'ระบบจัดการข้อมูล Excel PGSN', icon:'card-icon--teal', svg:'M2 2h12v12H2zM2 6h12M2 10h12M6 2v12M10 2v12', url:'https://script.google.com/macros/s/AKfycbz2ZracHO5QxhegX-fA7Kc3YUX7iWP1UjwvILoeg398dOBp5ZhhITkjJKj4IBmg0v8z/exec' },
